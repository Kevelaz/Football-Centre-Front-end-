function getPlayerInfo  () {
  ...
  const apiUrl  = isPlayerId
    ?`https://football-centre-e07679b245c6.herokuapp.com/main/players/${encodeURIComponent(input)}`
    :`https://football-centre-e07679b245c6.herokuapp.com/main/players/?name=${encodeURIComponent(input)}`
...
function markPlayerAsFavorite(playerId, buttonElement) {
  axios.post(`https://football-centre-e07679b245c6.herokuapp.com/main/players/${playerId}/favorite`)
  .then(response => {
...
document.getElementById('favorites-btn').addEventListener('click', function () {
  ...
  axios.get('https://football-centre-e07679b245c6.herokuapp.com/main/favorite-list')
    .then(response => {
...
function deletePlayer(playerId) {
  axios.delete(`https://football-centre-e07679b245c6.herokuapp.com/main/favorite-list/${playerId}`)
  .then(response => {
...
function editPlayer(playerId) {
  ...
  axios.put(`https://football-centre-e07679b245c6.herokuapp.com/main/favorite-list/${playerId}`, data)
    .then(response => {
      document.getElementById('favorites-btn').click()
