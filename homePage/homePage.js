...
document.getElementById('favorites-btn').addEventListener('click', function () {
  ...
  axios.get('http://localhost:3000/main/favorite-list')
    .then(response => {
...
function deletePlayer(playerId) {
  axios.delete(`http://localhost:3000/main/favorite-list/${playerId}`)
  .then(response => {
...
function editPlayer(playerId) {
  ...
  axios.put(`http://localhost:3000/main/favorite-list/${playerId}`, data)
    .then(response => {
      document.getElementById('favorites-btn').click()
